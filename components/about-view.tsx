...
const pillars: Pillar[] = [
	{
		title: "Energy Mindset",
		description:
			"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed non risus. Suspendisse lectus tortor, dignissim sit amet.",
		metric: "-34% Placeholder",
	},
	{
		...
		metric: "82% Placeholder",
	},
	{
		title: "Community Impact",
		description:
			"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id.",
		metric: "4 Goals Placeholder",
	},
];
...
export default function AboutView(): JSX.Element {
	...
	return (
		<div className="relative min-h-screen overflow-x-clip bg-[radial-gradient(circle_at_20%_20%,rgba(14,116,144,0.16),transparent_42%),radial-gradient(circle_at_85%_15%,rgba(244,114,182,0.12),transparent_38%),radial-gradient(circle_at_50%_85%,rgba(34,197,94,0.12),transparent_34%)] text-zinc-900 dark:text-zinc-100">
			<motion.div
			...
			<main>
					...
					<div className="grid items-center gap-14 lg:grid-cols-[1.15fr_0.85fr]">
						<div className="space-y-8">
							...
							<div className="flex flex-wrap gap-3">
								<Link
									className="group inline-flex items-center gap-2 rounded-full bg-zinc-900 px-5 py-2.5 font-medium text-white transition hover:-translate-y-0.5 hover:bg-zinc-800 dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-zinc-200"
									href="/"
								>
									Try AlfieAI
								...
								<Link
									className="inline-flex items-center gap-2 rounded-full border border-zinc-300/80 bg-white/80 px-5 py-2.5 font-medium text-zinc-700 backdrop-blur-lg transition hover:-translate-y-0.5 hover:border-zinc-400 hover:text-zinc-900 dark:border-zinc-700 dark:bg-zinc-900/70 dark:text-zinc-200 dark:hover:border-zinc-500"
									href="#features"
								>
									Explore Features
								</Link>
						...
						{features.map((feature, index) => (
							...
							>
								...
								<div className="relative">
									<div className="mb-4 inline-flex rounded-xl border border-zinc-300/60 bg-white/80 p-2.5 text-zinc-700 dark:border-zinc-600 dark:bg-zinc-950/65 dark:text-zinc-200">
										{feature.icon}
									</div>
					...
					<div className="grid gap-8 lg:grid-cols-[1fr_1fr]">
						<div className="rounded-3xl border border-zinc-200/70 bg-white/75 p-6 backdrop-blur-xl dark:border-zinc-700 dark:bg-zinc-900/60 sm:p-8">
							...
							<h2 className="text-balance text-3xl font-semibold leading-tight sm:text-4xl">
								AlfieAI Thinks Through the Community
							</h2>
							...
							<p className="mt-3 text-sm leading-relaxed text-zinc-700 dark:text-zinc-300 sm:text-base">
								One visible example is our thinking verbs. Students like Simon Ramsey and Luke Becker, alongside campus collaborators like Dr. Kruse, suggest words that appear while AlfieAI processes.
							</p>
						</div>
				...
				<Reveal className="mx-auto max-w-6xl px-6 py-24 sm:px-10 lg:px-14" delay={0.08}>
					<div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
						<div className="rounded-3xl border border-zinc-200/70 bg-white/75 p-6 backdrop-blur-xl dark:border-zinc-700 dark:bg-zinc-900/60">
							...
							<p className="mt-4 text-sm leading-relaxed text-zinc-700 dark:text-zinc-300 sm:text-base">
								Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum rutrum sem sit amet mauris dignissim, in pulvinar mi finibus. Nunc feugiat gravida leo, ac rhoncus sapien.
							</p>
							<p className="mt-3 text-sm leading-relaxed text-zinc-700 dark:text-zinc-300 sm:text-base">
								Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean aliquet dictum felis, eu feugiat lacus faucibus et. Curabitur in ex non justo efficitur viverra.
							</p>
						</div>
				...
				<Reveal className="mx-auto max-w-5xl px-6 pb-24 pt-16 sm:px-10 lg:px-14" id="founder-note" delay={0.12}>
			...
			<footer className="mx-auto mb-16 flex max-w-6xl w-full justify-center px-6 sm:px-10 lg:px-14">
				<Link
